...
namespace VRStandardAssets.Utils
{
    ...
    public class SelectionSlider : MonoBehaviour
    {
        ...
        [NonSerialized] public bool m_BarFilled;                                           // Whether the bar is currently filled.
        [NonSerialized] public bool m_GazeOver;                                            // Whether the user is currently looking at the bar.
